...
export type EventNote = { id: number; name: string; date: string; endDate: string; location: string; organizer: string; type: string; nextActions: string[]; generalNotes: string; followUpDone: boolean; createdAt: string; networking: NetworkingContact[]; prospects: Prospect[] };
